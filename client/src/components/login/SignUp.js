    ...
    return (
        <>
                ...
                <FormBox onSubmit={handleSubmit}>
                    <Label onChange={(e) => setFormInput({...formInput, firstName : e.target.value})}>Prenom*
                        <Input type="text" required={true} />
                    </Label>
                    <Label onChange={(e) => setFormInput({...formInput, lastName : e.target.value})}>Nom de famille*
                        <Input type="text" required={true} />
                    </Label>
                    <Label onChange={(e) => setFormInput({...formInput, email : e.target.value})}>Email*
                        <Input type="email" required={true} />
                    </Label>
                    <Label onChange={(e) => setFormInput({...formInput, phone : e.target.value})}>Numero de telephone*
                        <Input type="phone" required={true} />
                    </Label>
                    <Label onChange={(e) => setFormInput({...formInput,password: e.target.value})}>Mot de passe*
                        <Input type="password" required={true}/>
                    </Label>
                    <Label onChange={(e) => setFormInput({...formInput,confirmPassword: e.target.value})}>Confirmer Mot de passe*
                        <Input type="password" required={true}/>
                    </Label>
            ...
            <SignUpBox>
                ...
                <SignUpBtn onClick={() => setHasAccount(true)}>Se connecter</SignUpBtn>
            </SignUpBox>
            <MessageBox>
                {
                    message.map(e => {

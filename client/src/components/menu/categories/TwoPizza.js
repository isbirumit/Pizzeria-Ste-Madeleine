    ...
    return (
        <Body style={{ backgroundImage: `url(${BG})` }}>
            {isOpen ? (
                ...
                <PageContainer>
                    <Description>
                        Bienvenue chez Pizzeria Ste Madeleine, où nous sommes
                        fiers de servir les meilleures pizzas de la ville. Nos
                        pizzas sont préparées avec les meilleurs ingrédients
                        frais et cuits dans un four pour une saveur authentique.
                        Que vous aimiez la pizza classique Nature ou les
                        créations uniques de notre chef, nous avons quelque
                        chose pour tous les goûts. Commandez et découvrez
                        pourquoi nos pizzas sont les meilleures de la ville.
                    </Description>
                    {pizzas ? (
                        pizzas.map((pizza) => {
                            return (
                                <IndItemBox key={pizza.name + pizza._id}>

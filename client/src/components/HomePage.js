    ...
    return (
        <>
            <HomePageWrapper>
                ...
                <LinkAddress to={`https://goo.gl/maps/xzkYGqrxpBTy7HX68`}>700 Bd Laurier, Sainte-Madeleine, QC J0H 1S0</LinkAddress>

                <SpanLine />
                
                <RestaurantInformationBox>
                    <Img src={BG}/>
                    <Parag>Depuis notre ouverture en 2016, nous sommes fiers de servir la meilleure pizza en ville. Situé au cœur de Ste Madeleine, notre restaurant familial est un endroit chaleureux et convivial où vous pourrez savourer de délicieuses pizzas, des pâtes, des salades et bien plus encore.</Parag>
                </RestaurantInformationBox>
                ...
                <OrderNowBox>
                    ...
                    <OrderBox>
                        <Parag>Chez Pizzeria Ste Madeleine, nous aimons récompenser nos clients fidèles. C'est pourquoi nous offrons des points de récompense sur chaque commande en ligne que vous passez avec nous. Chaque fois que vous commandez en ligne, vous accumulez des points. C'est notre façon de vous remercier pour votre soutien continu et de rendre votre expérience de commande en ligne encore plus gratifiante. Commandez en ligne dès maintenant pour commencer à accumuler des points de récompense et profitez de remises exclusives sur vos pizzas et plats préférés chez Pizzeria Ste Madeleine.</Parag>
                        <OrderBtn onClick={() => navigate('/menu')}>Commandez Maintenant!</OrderBtn>
                    </OrderBox>
                </OrderNowBox>
